...
! function(doc) {
    ...
    var getElement = doc.getElementById.bind(doc);
    var createElement = doc.createElement.bind(doc);

    var totalCountSpan = getElement('total-count');
    var todosCountSpan = getElement('todos-count');
    var completedCountSpan = getElement('completed-count');

    var todoEle = getElement('todo'),
    ...
    function addItemToDOM(todo) {
        ...
        var complete = doc.createElement('button');
