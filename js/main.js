...
var currentTodoList = data.todos;
...
var totalCount_span = document.getElementById('total-count');
var todosCount_span = document.getElementById('todos-count');
var completedCount_span = document.getElementById('completed-count');
...
function refresh() {
    ...
    totalCount_span.innerHTML = totalsCount;
    todosCount_span.innerHTML = activeCount;
    completedCount_span.innerHTML = completedCount;
